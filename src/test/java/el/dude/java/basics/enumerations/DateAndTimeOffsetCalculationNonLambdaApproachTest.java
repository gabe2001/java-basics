 ...
 */
class DateAndTimeOffsetCalculationNonLambdaApproachTest
{
   ...
   {
      assertEquals(expected, DateAndTimeOffsetCalculationNonLambdaApproach.getResultingDateAndTime(from, amount, units));
   }
...
//              () -> DateAndTimeOffsetCalculationNonLambdaApproach.getResultingDateAndTime(from, amount, units));
...
//   }
   ...
   {
      assertEquals(expected, DateAndTimeOffsetCalculationNonLambdaApproach.getResultingDateAndTime(from, period, units));
   }
   ...
   {
      assertEquals(expected, DateAndTimeOffsetCalculationNonLambdaApproach.getResultingDateAndTime(from, period));
   }

   @ParameterizedTest
   @EnumSource(DateAndTimeOffsetCalculationNonLambdaApproach.class)
   void do_something_with_the_enums(final DateAndTimeOffsetCalculationNonLambdaApproach theEnum)
   {
      assertTrue(theEnum.getUnits().length() > 0);
   }
   ...
   //@formatter:on
   void validate_the_unit_strings(final DateAndTimeOffsetCalculationNonLambdaApproach theEnum, final String theString)
   {
      assertEquals(theString, theEnum.getUnits());
   }
